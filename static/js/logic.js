...
// function firstMeetingStatusCheck() {
//     if (document.getElementById('m1s').checked) {
//         console.log("here3");
//         document.getElementById('schedule-interview').style.display = 'block';
//         document.getElementById('second-meeting').style.display = 'block';
//     } 
//     else if(document.getElementById('m1r').checked) {
//         console.log(document.getElementById('m1r').checked);
...
//    }
//    else{
//         console.log(document.getElementById('m1h').checked);
//         console.log("here2");
//         document.getElementById('schedule-interview').style.display = 'none';
//         document.getElementById('second-meeting').style.display = 'none';
//         document.getElementById('final-attatchment').style.display = 'none';
...
function firstMeetingStatusCheck() {
    ...
    else if(document.getElementById('m1h').checked){
        console.log(document.getElementById('m1h').checked);
        console.log("here2");
        document.getElementById('schedule-interview').style.display = 'none';
        document.getElementById('second-meeting').style.display = 'none';
...
function secondMeetingStatusCheck() {
    if (document.getElementById('m2s').checked) {
        document.getElementById('final-attatchment').style.display = 'block';
        document.getElementById('more_interview').style.display = 'block';
    } 
    else if(document.getElementById('m2r').checked || document.getElementById('m2h').checked) {
        document.getElementById('final-attatchment').style.display = 'none';
        document.getElementById('more_interview').style.display = 'none';
   }
}
...
function convertDate(d){
    ...
    return parts[2]+"-"+months[parts[0]]+"-"+parts[1].substring(0, 2);
}
